...
export async function loadExternalConnectors(connectorsRoot, registry, manifestFile = "manifest.json") {
    ...
    for (const entry of manifest.connectors || []) {
        ...
        if (typeof factory !== "function")
            throw new Error(`Connector module ${entry.module} missing default export factory`);
        if (entry.configBuilder) {
            ...
            if (typeof builder === "function")
                registry.registerConfigBuilder(entry.type, builder);
        }
