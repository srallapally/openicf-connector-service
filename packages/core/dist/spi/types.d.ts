...
export type Complex = {
    [k: string]: Primitive | Primitive[] | Complex | Complex[];
};
...
export type AttrType = "string" | "integer" | "boolean" | "datetime" | "reference" | "complex";
...
export interface SearchOp {
    search(objectClass: string, filter: any, handlerOrOptions?: ResultsHandler | OperationOptions, options?: OperationOptions): Promise<{
        results: ConnectorObject[];
        nextOffset?: number;
    } | SearchResult>;
}
...
export interface SyncOp {
    sync(objectClass: string, token: SyncToken | null, options?: OperationOptions): Promise<{
        token: SyncToken;
        changes: ConnectorObject[];
    }>;
}
...
export type ConnectorSpi = Partial<CreateOp & UpdateOp & DeleteOp & GetOp & SearchOp & SchemaOp & TestOp & SyncOp & ScriptOnConnectorOp & ResolveUsernameOp & ValidateOp & import("./icf-compat.js").AuthenticateOp & import("./icf-compat.js").BatchOp & import("./icf-compat.js").UpdateAttributeValuesOp & import("./icf-compat.js").ScriptOnResourceOp & import("./icf-compat.js").ConnectorEventSubscriptionOp & import("./icf-compat.js").SyncEventSubscriptionOp>;
